...
model=Lenet5()
model.load_state_dict(torch.load("Lenet5_v5.pth"))
...
# --------------------------------
export_onnx_file = "Lenet5_v5.onnx"
...
onnx_model = onnx.load("Lenet5_v5.onnx")
# 验证模型的结构并确认模型具有有效的架构
onnx.checker.check_model(onnx_model)

ort_session = onnxruntime.InferenceSession("Lenet5_v5.onnx")
